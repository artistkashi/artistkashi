...
Revision ID: e912daf3bdbb
Revises:
Create Date: 2026-06-26 10:12:30.288461
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_course_categories_slug"), "course_categories", ["slug"], unique=True
    )
    op.create_table(
        "product_categories",
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "blocked", "flagged", name="reviewstatus"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("is_deleted", sa.Boolean(), nullable=False),
        sa.CheckConstraint("rating >= 0 AND rating <= 5", name="check_review_rating"),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "user_id", "type", "entity_id", name="uq_review_user_entity"
        ),
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_reviews_is_deleted"), "reviews", ["is_deleted"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("password", "google", name="providertype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "pending", "paid", "failed", "refunded", name="coursepaymentstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_course_payments_course_id"),
        "course_payments",
        ["course_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_course_payments_razorpay_order_id"),
        "course_payments",
        ["razorpay_order_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_course_payments_user_id"), "course_payments", ["user_id"], unique=False
    )
    op.create_table(
        "course_sections",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_course_sections_course_id"),
        "course_sections",
        ["course_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "source_type",
            sa.Enum("upload", "external_url", name="image_source_type"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_index(
        op.f("ix_review_reports_user_id"), "review_reports", ["user_id"], unique=False
    )
    op.create_table(
        "wishlist",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("processing", "ready", "failed", name="lessonstatus"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(["course_id"], ["courses.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["section_id"], ["course_sections.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_course_lessons_section_id"),
        "course_lessons",
        ["section_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_course_payments_user_id"), table_name="course_payments")
    op.drop_index(
        op.f("ix_course_payments_razorpay_order_id"), table_name="course_payments"
    )
    op.drop_index(op.f("ix_course_payments_course_id"), table_name="course_payments")
    ...
    op.drop_index(
        op.f("ix_user_auth_providers_user_id"), table_name="user_auth_providers"
    )
